...
export const DISTRIBUTOR_CONTRACT_ID = import.meta.env.VITE_DISTRIBUTOR_CONTRACT_ID || ''
...
export const isConfigured = () =>
  Boolean(REGISTRY_CONTRACT_ID && DISTRIBUTOR_CONTRACT_ID && TOKEN_CONTRACT_ID)
